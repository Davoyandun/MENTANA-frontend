		...
		<div className="lg:h-44 bg-chaarcoal300">
			<div className='h-4/6 flex flex-col justify-center'>
				<div className='h-24 flex flex-col items-center justify-center'>
					<div className='flex flex-row h-10 w-10 justify-center'>
						<Image 
							height={45} 
							width={45} 
					...
					<p className='text-white font-medium text-lg'>mentanaInfo@gmail.com</p>
			...
			<div className='h-2/6 flex justify-center items-center'>
				<p className='text-white font-medium text-lg text-center'>© 2024 Mentana - Todos los derechos reservados</p>
			</div>
