...
export default function StepToUse() {
	return (
		<div className="bg-gradient-to-b from-whiteSmokeBase to-chaarcoalLight  min-h-screen w-full flex items-center justify-center">
			<div className="bg-white w-[90%] lg:h-[400px] justify-evenly gap-12 rounded-xl flex flex-col border-l-8 border-solid border-teaRose500 lg:mb-32 mb-32 py-3 lg:py-0">
