...
export default function Banner() {
	return (
		<>
			<div className="flex flex-col w-[90%] h-full pt-5 lg:pt-0 lg:flex-row bg-white lg:h-[500px] lg:w-11/12 rounded-xl gap-5">
				<div className="lg:w-2/4 h-full flex flex-col justify-center lg:pl-12 self-center items-center lg:items-start">
					<div className='w-90% lg:w-full flex flex-col items-center lg:items-start gap-3 lg:gap-0'>
						<p className="text-2xl text-center lg:text-start lg:text-5xl  font-bold text-chaarcoalBase">
